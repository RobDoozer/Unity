...
public:
	KinectReceiver() : Node("kinect_receiver3") {
		...
		depth_topic_ = "/kinect1/qhd/image_depth_rect";
		rgb_topic_   = "/kinect1/qhd/image_color_rect";
		camera_info_topic_ = "/kinect1/qhd/camera_info";
		points_topic_ = "/kinect1/test/points";
...
private:
	...
	void publish_rgb(const rclcpp::Time& stamp) {
		auto msg = sensor_msgs::msg::Image();
		msg.header.stamp = stamp;
		msg.header.frame_id = "kinect1_color_optical_frame";
		msg.height = height_;
		msg.width = width_;
		msg.encoding = "rgb8";
		msg.step = width_ * 3;
	...
	void publish_camera_info(const rclcpp::Time& stamp) {
		...
		cam_info.header.frame_id = "kinect1_color_optical_frame";
	...
	void try_publish_pointcloud(const rclcpp::Time& stamp) {
		...
		cloud->header.frame_id = "kinect1_color_optical_frame";
		...
		output.header.frame_id = "kinect1_color_optical_frame";
